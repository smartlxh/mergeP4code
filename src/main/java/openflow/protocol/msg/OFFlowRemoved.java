...
public class OFFlowRemoved extends OFMessage {
    ...
    public enum POFFlowRemovedReason {
        POFPRR_IDLE_TIMEOUT,
        POFPRR_HARD_TIMEOUT,
        POFPRR_DELETE
    }
    ...
    protected POFFlowRemovedReason reason;
    ...
    /**
     * Gets a copy of the POFMatch object for this FlowMod, changes to this
     ...
     * @param match
     */
    public OFFlowRemoved setMatch(POFMatch match) {
        this.match = match;
        return this;
    }
     ...
     * @return the reason
     */
    public POFFlowRemovedReason getReason() {
        return reason;
    }
     ...
     */
    public OFFlowRemoved setReason(POFFlowRemovedReason reason) {
        this.reason = reason;
        return this;
    }
    ...
    public void readFrom(ByteBuf data) {
        ...
        this.reason = POFFlowRemovedReason.values()[(0xff & data.readByte())];
        data.readByte(); // pad
